  ...
  return (
    <div>
      <div className="w-full h-full grid place-items-center">
        <div className="  w-[333px] sm:w-[580px] md:w-[750px]  lg:w-[960px] xl:w-[1050px] 2xl:w-[1150px] mt-[30px] md:mt-[47px]  ">
          <div className="text-center grid place-items-center">
            <h5 className="text-[14px] font-bold">E-commerce Development</h5>
            <h1 className="w-[300px] sm:w-[500px] md:w-[700px] xl:w-[820px] text-[24px] sm:text-[30px] md:text-[40px] xl:text-[45px] mt-[17px] font-bold md:leading-[60px]">
              Elevating E-Commerce Experiences, One Click at a Time
            </h1>
            <p className="w-[317px] sm:w-[500px] md:w-[670px] xl:w-[750px] text-[13px] xl:text-[14px] mt-[30px] font-medium leading-[20px] text-[#333]">
              Fuel your online retail success with our eCommerce development
              expertise. We create feature-rich, secure, and scalable eCommerce
              solutions that boost sales and customer satisfaction
            </p>
            <Link to="/service/webapp/ecommercedevelopment/help">
        ...
        <div className="   w-[333px] sm:w-[580px] md:w-[750px]  lg:w-[960px] xl:w-[1050px] 2xl:w-[1150px] mt-[30px] md:mt-[70px] lg:mt-[100px]  xl:mt-[120px]  ">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-y-[30px] md:gap-y-[70px] lg:gap-y-[0px] gap-x-[70px] lg:gap-x-[30px] xl:gap-x-[15px] 2xl:gap-x-[60px]">
            <div className="w-[333px] sm:w-[580px] md:w-[340px] lg:w-[300px] xl:w-[340px] h-[356px] sm:h-[330px] md:h-[356px] lg:h-[340px] xl:h-[356px] py-[36px] lg:py-[30px] xl:py-[36px] px-[32px] lg:px-[25px] xl:px-[32px] border-[1px] border-[#5E8E3E] rounded-[14px] bg-[#fff]">
              <img src="/images/shopify.svg"></img>
              <h1 className="text-[18px] lg:text-[16px] xl:text-[18px] mt-[50px] font-bold ">Shopify Development</h1>
              <p className="text-[12px] lg:text-[11px] xl:text-[12px] mt-[22px] font-medium ">
                Empower your online store with our Shopify development services.
                We specialize in crafting tailored, conversion-focused Shopify
                solutions that enhance your brand, streamline operations, and
                drive sales. From custom design to seamless integrations, we're
                your partner in e-commerce success.
              </p>
            </div>
            <div className="w-[333px] sm:w-[580px] md:w-[340px] lg:w-[300px] xl:w-[340px] h-[356px] sm:h-[330px] md:h-[356px] lg:h-[340px] xl:h-[356px] py-[36px] lg:py-[30px] xl:py-[36px] px-[32px] lg:px-[25px] xl:px-[32px] border-[1px] border-[#5E8E3E] rounded-[14px] bg-[#fff]">
              <img src="/images/magento.svg"></img>
              <h1 className="text-[18px] lg:text-[16px] xl:text-[18px] mt-[50px] font-bold ">Magento Development</h1>
              <p className="text-[12px] lg:text-[11px] xl:text-[12px] mt-[22px] font-medium ">
                Empower your online store with our Shopify development services.
                We specialize in crafting tailored, conversion-focused Shopify
                solutions that enhance your brand, streamline operations, and
            ...
            <div className="w-[333px] sm:w-[580px] md:w-[340px] lg:w-[300px] xl:w-[340px] h-[356px] sm:h-[330px] md:h-[356px] lg:h-[340px] xl:h-[356px] py-[36px] lg:py-[30px] xl:py-[36px] px-[32px] lg:px-[25px] xl:px-[32px] border-[1px] border-[#5E8E3E] rounded-[14px] bg-[#fff]">
              <img src="/images/opencart.svg"></img>
              <h1 className="text-[18px] lg:text-[16px] xl:text-[18px] mt-[50px] font-bold ">OpenCart Development</h1>
              <p className="text-[12px] lg:text-[11px] xl:text-[12px] mt-[22px] font-medium ">
                Empower your online store with our Shopify development services.
                We specialize in crafting tailored, conversion-focused Shopify
                solutions that enhance your brand, streamline operations, and
        ...
        <div className="sm:text-center md:text-start md:flex  w-[333px] sm:w-[580px] md:w-[750px] lg:w-[960px] xl:w-[1050px] 2xl:w-[1150px] mt-[30px] sm:mt-[40px] md:mt-[65px] lg:mt-[100px] xl:mt-[120px] 2xl:mt-[120px] xl:mb-[10px] ">
...
export default E_commerce_developmen;
