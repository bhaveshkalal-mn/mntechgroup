...
function CustomModal({ isOpen, onClose }) {
  ...
  return (
    // model 1
    // <div className="fixed inset-0 flex items-center justify-center mt-[15px] z-50">
    //   <div className="fixed inset-0 bg-black opacity-50"></div>
    //   <div className="relative z-10 bg-white rounded-lg shadow-lg sm:p-6  lg:p-0 2xl:p-6 h-[460px] sm:h-[585px] md:h-[80%] lg:h-[470px] xl:h-[540px] 2xl:h-[606px] w-[310px] sm:w-[465px] lg:w-[490px] xl:w-[530px] 2xl:w-[554px]">
    ...
    //         <div className="flex ">
    //         <p className="text-[12px] font-medium leading-[20px] mt-[5px]">Experience : 1 year or more    </p>
    //         <div className=" mt-[8px] ml-[8px] w-[1px] xl:w-[1.5px] h-[15px] bg-[#CDCDCD]"></div>
    //         <div><p className="ml-[8px] text-[12px] font-medium leading-[20px] mt-[5px]">Work : Remotely  </p></div>
    //         <div className=" mt-[8px] ml-[8px] w-[1.5px] h-[15px] bg-[#CDCDCD]"></div>
    //         <div><p className="ml-[8px] text-[12px] font-medium leading-[20px] mt-[5px]">  Time : Mon-Fri</p></div>
    //         </div>
    //       </div>
    //       <div className="w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[420px] xl:w-[450px]  h-[1px] mt-[25px] bg-[#E9E9E9]"></div>
           
    //        <div className="mt-[20px] w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[435px] xl:w-[450px]">
    //         <h1 className="text-[12px] font-semibold leading-[20px]">Key Skills & Behaviours:</h1>
    //         <ul className="ml-[16px] mt-[10px] list-disc">
    //           <li className="text-[12px] font-medium leading-[20px]">Professional experience working with native iOS and Android and hybrid (Flutter) platforms.</li>
    //           <li className="text-[12px] font-medium leading-[20px]">Proficiency and familiarity with the following programming languages: Flutter(Dart), Java, JS, JSON. SQL Lite</li>
    //           <li className="text-[12px] font-medium leading-[20px]">Architect, build and maintain excellent in native iOS and Android & Flutter applications with clean code.</li>
    //           <li className="text-[12px] font-medium leading-[20px]">Familiarity with SwiftLint, iOS Lifecycle, API Handling, Unit Test and Integration Test for mobile applications.</li>
    //           <li className="text-[12px] font-medium leading-[20px]">Developing strong quantitative skills.</li>
    //           <li className="text-[12px] font-medium leading-[20px]">Driven, hungry for knowledge, responsible, mature and independent.</li>
    //           <li className="text-[12px] font-medium leading-[20px]">Perform full life-cycle development.</li>
              
    //         </ul>
    //         </div>
    //         <div className="mt-[40px]">
    //         <h1 className="text-[12px] font-semibold leading-[20px]">Education</h1>
    //         <ul className="ml-[16px] mt-[10px] list-disc">
    //           <li className="text-[12px] font-medium leading-[20px]">BCA or relevant</li>
    //           </ul>
    //        </div>

    //        <button onClick={onClose} className="mt-[20px] sm:mt-[30px] lg:mt-[20px] xl:mt-[30px] w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[435px] xl:w-[450px] h-[50px] sm:h-[55px] lg:h-[50px] xl:h-[55px] rounded-[10px] bg-[#0904F2] text-[16px] font-medium text-[white]">
    //        Send Your CV
    //       </button>
    ...
    //         <button onClick={onClose} className="w-[80px] h-[20px]">
      ...
      <div className="relative z-10 bg-white rounded-lg shadow-lg sm:p-6  lg:p-0 2xl:p-6 h-[460px] sm:h-[585px] md:h-[80%] lg:h-[470px] xl:h-[540px] 2xl:h-[606px] w-[310px] sm:w-[465px] lg:w-[490px] xl:w-[530px] 2xl:w-[554px]">
        <div className="ml-[10px] sm:ml-[27px] lg:ml-[30px] xl:ml-[40px] 2xl:ml-[27px] mt-[10px] sm:mt-[10px]  xl:mt-[15px]">
           ...
           <div className=" grid place-items-center mt-[100px] sm:mt-[125px] md:mt-[120px] lg:mt-[105px] xl:mt-[140px] 2xl:mt-[145px] w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[435px] xl:w-[450px]">
              ...
              <button onClick={onClose} className=" mt-[25px] sm:mt-[30px] lg:mt-[30px] xl:mt-[30px] w-[130px] sm:w-[150px]  h-[50px] sm:h-[60px] lg:h-[55px] xl:h-[60px] rounded-[10px] bg-[#0904F2] text-[18px] font-medium text-[white]">
           Okay
          </button>
            </div>
            </div>
  ...
  return (
    <div>
      <div className="w-full h-full grid place-items-center">
        ...
        <div className="px-[20px] w-[333px] sm:w-[580px] md:w-[750px] lg:w-[960px] xl:w-[1050px] 2xl:w-[1150px] mb-[90px] sm:mb-[30px] lg:mb-[0px] 2xl:mb-[16px]  sm:mt-[20px] md:mt-[50px] lg:mt-[100px] xl:mt-[105px] 2xl:mt-[105px] ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-[20px] lg:gap-x-[40px] xl:gap-x-[40px] mt-[56px] place-items-center ">
            <div
              ...
              className="p-[30px]  sm:p-[40px]  lg:py-[0px] lg:px-[50px] xl:py-[30px] w-[333px] sm:w-[570px] lg:w-[465px] h-[236px] sm:h-full xl:w-[505px]  2xl:w-[550px] "
            >
              <div className=" ">
          <div className=" ">
            <h1 className="text-[24px] font-bold">Mobile App Developer</h1>
          ...
          <div className="w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[420px] xl:w-[450px]  h-[1px] mt-[20px] bg-[#E9E9E9]"></div>
           
           <div className="mt-[20px] w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[435px] xl:w-[450px]">
            <h1 className="text-[12px] font-semibold leading-[20px]">Key Skills & Behaviours:</h1>
            <ul className="ml-[16px] mt-[10px] list-disc">
              <li className="text-[12px] font-medium leading-[20px]">Professional experience working with native iOS and Android and hybrid (Flutter) platforms. <button className="text-[#0904F2]"> Read More</button></li>
              ...
              <button
                onClick={openModal}
                className="mt-[30px] sm:mt-[35px] xl:mt-[30px] w-[98px] h-[45px] lg:w-[90px] lg:h-[40px] xl:w-[98px] xl:h-[45px] text-[14px] lg:text-[13px] xl:text-[14px] rounded-[8px]  bg-[#0904F2] text-[#FFF]"
              >
                Apply
              </button>
            </div>
          ...
          <div className="w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[420px] xl:w-[450px]  h-[1px] mt-[20px] bg-[#E9E9E9]"></div>
           ...
           <div className="mt-[20px] w-[290px] sm:w-[360px] md:w-[360px]  lg:w-[435px] xl:w-[450px]">
            <h1 className="text-[12px] font-semibold leading-[20px]">Key Skills & Behaviours:</h1>
            <ul className="ml-[16px] mt-[10px] list-disc">
              <li className="text-[12px] font-medium leading-[20px]">Executes test cases under varying circumstances</li>
              <li className="text-[12px] font-medium leading-[20px]">Documents and evaluates test results. <button className="text-[#0904F2]"> Read More</button></li>
