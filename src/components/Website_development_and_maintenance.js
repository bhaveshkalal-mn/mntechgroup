...
function Website_development_and_maintenance() {
  return (
    <div>
      <div className="w-full h-full grid place-items-center">
        <div className=" md:flex  w-[333px] sm:w-[580px] md:w-[750px]  lg:w-[960px] xl:w-[1050px] 2xl:w-[1150px] mt-[30px] md:mt-[47px]  ">
          <div className="hidden sm:block w-[539px] md:w-[450px] xl:w-[500px] 2xl:w-[539px] h-[400px] md:h-[450px] py-[10px]">
            <img className="" src="/images/websiteprofile.svg"></img>
          </div>
          <div className="sm:hidden   py-[10px]">
            <img className="" src="/images/responsivewebsiteprofile.svg"></img>
          </div>
          <div className=" w-[333px] sm:text-center md:text-start sm:w-[580px] md:w-[460px] lg:w-[430px] h-[430px] sm:h-[385px] md:h-[450px] md:ml-[50px] lg:ml-[80px] xl:ml-[120px] 2xl:ml-[170px] mt-[30px] sm:mt-[-20px] md:mt-[1px] ">
            <div>
              <p1 id="experiencepagesection1-p1">
              ...
              <p id="experiencepagesection1-p2" className="mt-[20px]">
                Unlock your online potential with our expert website development
                service. We craft responsive, user-friendly websites that drive
                results
              </p>
              <Link to="/service/webapp/websitedevelopmentandmaintenance/help">
...
export default Website_development_and_maintenance;
