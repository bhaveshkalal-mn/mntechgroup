...
=======
        <div className=" w-[333px] sm:w-[580px] md:w-[750px] lg:w-[960px] xl:w-[1100px] 2xl:w-[1150px] ">
...
=======
        <div className=" mt-[40px] sm:mt-[70px] md:mt-[100px] lg:mt-[120px] md:flex w-[333px] sm:w-[580px]  md:w-[750px] lg:w-[960px] xl:w-[1100px] 2xl:w-[1150px] sm:flex ">
          <div className="  lg:w-[900px] lg:h-[350px] xl:w-[570px]  2xl:w-[550px]  rounded-[11px] text-white ">
>>>>>>> 758f2be69888acb3bb3391ed70608c45ba2a26c2
            <p
...
=======
            <div className="grid place-items-center p-[30px] md:ml-[10px] lg:ml-[80px]">
>>>>>>> 758f2be69888acb3bb3391ed70608c45ba2a26c2
...
=======
        <div className=" mt-[40px] sm:mt-[70px] md:mt-[100px] lg:mt-[100px] md:flex w-[333px] sm:w-[580px]  md:w-[750px] lg:w-[960px] xl:w-[1100px] 2xl:w-[1150px]">
          <div className="grid  sm:grid-cols-3 lg:grid-cols-5 sm:gap-4 sm:gap-y-8 md:gap-y-8 lg:gap-y-0 md:gap-24 lg:gap-3 xl:gap-14 r">
>>>>>>> 758f2be69888acb3bb3391ed70608c45ba2a26c2
...
=======
        <div className=" bg-[#F8F8F8] rounded-[14px] p-[20px] px-[30px]  sm:py-[50px] sm:px-[30px] md:px-[60px] mt-[50px] sm:mt-[75px]  lg:mt-[95px]   h-[140px] sm:h-[300px] md::h-[341px] lg:h-[330px] xl:h-[341px] w-[333px] sm:w-[580px]  md:w-[750px] lg:w-[960px] xl:w-[1100px] 2xl:w-[1150px] mb-[80px] sm:mb-[-10px]">
>>>>>>> 758f2be69888acb3bb3391ed70608c45ba2a26c2
          <div className="flex">
            <div>
              <p
...
=======
            <div className="xl:ml-[100px] ml-[20px] sm:ml-[0px] mt-[7px] sm:mt-[-20px] md:mt-[7px] xl:mt-[-18px]">
>>>>>>> 758f2be69888acb3bb3391ed70608c45ba2a26c2
